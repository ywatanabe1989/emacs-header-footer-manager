<!-- ---
!-- Timestamp: 2025-05-11 15:32:27
!-- Author: ywatanabe
!-- File: /home/ywatanabe/.emacs.d/lisp/emacs-header-footer-manager/docs/guidelines/guidelines_programming_test_driven_workflow_rules.md
!-- --- -->
...
1. **Start with tests**
   ...
   - Use `./run_tests.sh --debug` for running tests
     - `./.*REPORT*.org` (hidden file as the actual entity) will be created. 
     - Old reports will be automatically cleaned up. Please untrack from git as well.
     - On the other hand, please start tracking the latest one.
